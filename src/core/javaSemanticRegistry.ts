...
export const JAVA_SEMANTIC_RULES: JavaSemanticRule[] = [
  ...
  { id: "application-context", pattern: /\b[A-Za-z0-9_]*Context\.(?:current|enter|newScope|callWith[A-Za-z0-9_]*)\b/, kind: "context-resolution", reason: "application context scope or lookup", defaultOwnership: "target-owned" },
  ...
  { id: "value-object-factory", pattern: /\b[A-Z][A-Za-z0-9_]*(?:Context|Result|Outcome|Eligibility)\.(?:empty|no|failed|ok|skipped)\b/, kind: "calculation", reason: "value-object factory", defaultOwnership: "reviewed-exclusion" },
