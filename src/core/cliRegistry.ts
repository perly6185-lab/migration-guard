...
export const CLI_COMMAND_NAMES = [
  ...
  "method-extraction", "sync-issues", "issue-control", "self-refactor", "java-endpoint", "full-replacement", "migrate", "ci", "contract", "dual-run", "preview", "artifacts", "handoff", "policy", "vmp", "semantics"
] as const;
